...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      // Fixo no topo do contêiner rolável da DataTable: em lista longa o
      // organizador perde a referência de qual coluna é qual. `bg-card` é
      // obrigatório — sem fundo opaco as linhas passam por baixo e sobrepõem.
